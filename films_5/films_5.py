...
series_1 = Series(title="Cube", year="1999", genre="thriller",
                  number=9, episode=2, season=1)
series_2 = Series(title="Alf", year="1989", genre="comedy",
                  number=21, episode=4, season=2)
series_3 = Series(title="07 zgłoś się", year="1978", genre="criminal",
                  number=19, episode=3, season=3)
...
def new_series(a_title, a_year, a_genre, a_number, an_episode, a_season):
    series_x = Series(title=a_title, year=a_year, genre=a_genre,
                      number=a_number, episode=an_episode, season=a_season)
